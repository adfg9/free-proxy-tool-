...
const BUILTIN_PROXIES = [
  ...
  { host: '115.239.234.43', port: 7302, type: 'http', source: 'verified-2digit' }, // avg=96ms min=84ms max=118ms 100% (ERD-HTTP)

  // ⚡ 3-DIGIT STABLE (avg 118ms, 100%): sub-200ms, always reliable
  { host: '59.110.63.234', port: 80, type: 'http', source: 'verified-sub200' }, // avg=118ms min=112ms max=127ms 100%

  // 🎯 SOLID 100% STABLE (avg 650-700ms, 100% 5/5 rounds): zero-fallback reliability
  { host: '141.193.213.254',  port: 80, type: 'http', source: 'verified-solid' }, // avg=656ms min=440ms 100%
  { host: '159.112.235.94',   port: 80, type: 'http', source: 'verified-solid' }, // avg=656ms min=455ms 100%
  { host: '31.43.179.194',    port: 80, type: 'http', source: 'verified-solid' }, // avg=665ms min=445ms 100%
  { host: '45.131.4.250',     port: 80, type: 'http', source: 'verified-solid' }, // avg=668ms min=443ms 100%
  { host: '141.101.120.214',  port: 80, type: 'http', source: 'verified-stable' }, // avg=717ms min=458ms  80%
  { host: '103.21.244.132',   port: 80, type: 'http', source: 'verified-solid' }, // avg=872ms min=440ms 100%
